...
# constants
p=`pwd`
PYTHON=python3  # this depends on which command do you run python, usually it's `python` or `python3`
...
# input and output paths), or add a paramsCONFIG shortcut (either modifyting case 1-3 or adding cases 4+).
    ...
    0)
        ...
        infile=$3 #'/Users/danisized/Documents/GitHub/SSAML/sample_data_FAKE.csv'
        outdir=$4 #'/Users/danisized/Documents/GitHub/SSAML/OUTcovaFAKE'
        peopleTF=1
        survivalTF=0 # no survival analysis data
        resampReps=100 
        bootReps=1000  # this should be 1000, but that takes a long time!
        maxlist='500 1000 1500 2000 2500'
        ilist=`seq 0 1 10`
        conflist='0.955'
        #infile='SET_BY_USER'
        #outdir='SET_BY_USER'
    ...
    1)
        ...
        infile=$3 #'/home/wolfgang/repos/SSAML/sample_data_st.csv'
        outdir=$4 #'/home/wolfgang/repos/SSAML/OUTst'
    ...
    2)
        ...
        infile=$3 #'/home/wolfgang/repos/SSAML/sample_data_cova.csv'
        outdir=$4 #'/home/wolfgang/repos/SSAML/OUTcovaFAKE'
    ...
    3)
        ...
        infile=$3 #'/home/wolfgang/repos/SSAML/sample_data_bai_mortality.csv'
        outdir=$4 #'/home/wolfgang/repos/SSAML/OUTbai'
