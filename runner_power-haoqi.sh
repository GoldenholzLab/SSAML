...
if [[ $localMAC -eq 1 ]]; then
    ...
    if [[ $dataTYPE -eq 0 ]]; then
        ...
        outdir='/data/HaoqiSun/SSAML/github/OUTst'
        peopleTF=1
        survivalTF=0
        resampReps=40
        ilist=`seq 0 1 24`
        ...
        infile='/data/HaoqiSun/SSAML/github/risk_7day-simplified.csv'
        outdir='/data/HaoqiSun/SSAML/github/OUTcova'
        peopleTF=0
        survivalTF=0
        resampReps=40
        ilist=`seq 0 1 24`
        ...
        infile='/data/HaoqiSun/SSAML/github/BA_For_Daniel.csv'
        outdir='/data/HaoqiSun/SSAML/github/OUTbai'
        peopleTF=1
        survivalTF=1
        resampReps=10
        ilist=`seq 0 1 99`
        maxlist='500 1000 1500 2000'
    elif [[ $dataTYPE -eq 3 ]]; then
        infile=$3
        outdir=$4
        peopleTF=1
        survivalTF=0
